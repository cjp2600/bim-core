...
class CatalogDiscountCouponGen extends CodeGenerator
{
    ...
    public function generateAddCode($params)
    {
        ...
        foreach ($this->ownerItemDbData as $accData) {
            ...
            $code = $code . $this->buildCode('CatalogDiscountCouponIntegrate', 'Add',
    ...
    public function generateUpdateCode($params)
    {
        ...
        foreach ($this->ownerItemDbData as $accData) {
            ...
            $code = $code . $this->buildCode('CatalogDiscountCouponIntegrate', 'Update',
                    array($updateFields['COUPON'], $updateFields)) . PHP_EOL . PHP_EOL;
        }
