...
class CatalogGen extends CodeGenerator
{
    ...
    public function generateUpdateCode( $params ){
        ...
        $code = $code . $this->buildCode('CatalogIntegrate', 'Update', array( $updateFields['IBLOCK_CODE'], $updateFields ) );
    ...
    public function checkParams( $params  ) {
        ...
        $this->ownerItemDbData = array('YANDEX_EXPORT' => 'N', 'SUBSCRIPTION' => 'N', 'IBLOCK_CODE' => $iblockData['CODE'] );
