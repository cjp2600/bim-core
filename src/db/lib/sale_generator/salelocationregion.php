...
class SaleLocationRegionGen extends CodeGenerator
{
    ...
    public function generateAddCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $regionData  ){
            ...
            $code = $code . $this->buildCode('SaleLocationRegionIntegrate', 'Add', array( $addFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateUpdateCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $regionData  ){
            ...
            $code = $code . $this->buildCode('SaleLocationRegionIntegrate', 'Update', array(  $updateFields ) ) .PHP_EOL.PHP_EOL;
        }
