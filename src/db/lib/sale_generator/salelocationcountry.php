...
class SaleLocationCountryGen extends CodeGenerator
{
    ...
    public function generateAddCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $countryData  ){
            ...
            $code = $code . $this->buildCode('SaleLocationCountryIntegrate', 'Add', array( $addFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateUpdateCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $countryData  ){
            ...
            $code = $code . $this->buildCode('SaleLocationCountryIntegrate', 'Update', array(  $updateFields ) ) .PHP_EOL.PHP_EOL;
        }
