...
class SaleLocationGroupGen extends CodeGenerator
{
    ...
    public function generateAddCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $groupData  ){
            ...
            $code = $code . $this->buildCode('SaleLocationGroupIntegrate', 'Add', array( $addFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateUpdateCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $groupData  ){
            ...
            $code = $code . $this->buildCode('SaleLocationGroupIntegrate', 'Update', array(  $updateFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateDeleteCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $groupData  ){
            $code = $code . $this->buildCode('SaleLocationGroupIntegrate', 'Delete', array( $groupData['LANG'][0]['LID'], $groupData['LANG'][0]['NAME']) );
        }
