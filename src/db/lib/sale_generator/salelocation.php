...
class SaleLocationGen extends CodeGenerator
{
    ...
    public function generateUpdateCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $locationData  ){
            ...
            $code = $code . $this->buildCode('SaleLocationIntegrate', 'Update', array(  $updateFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateDeleteCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $locationData  ){
            $code = $code . $this->buildCode('SaleLocationIntegrate', 'Delete', array( LANGUAGE_ID, $locationData['COUNTRY_NAME'], $locationData['CITY_NAME'] ) );
        }
