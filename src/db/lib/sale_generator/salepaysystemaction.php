...
class SalePaySystemActionGen extends CodeGenerator
{
    ...
    public function generateAddCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $actionData  ){
            ...
            $code = $code . $this->buildCode('SalePaySystemActionIntegrate', 'Add', array( $addFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateUpdateCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $actionData  ){
            ...
            $code = $code . $this->buildCode('SalePaySystemActionIntegrate', 'Update', array( $updateFields['NAME'], $updateFields['PERSON_TYPE_ID'], $updateFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateDeleteCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $actionData  ){
            $code = $code . $this->buildCode('SalePaySystemActionIntegrate', 'Delete', array( $actionData['NAME'], $actionData['PERSON_TYPE_ID'] ) );
        }
