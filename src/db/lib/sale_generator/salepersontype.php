...
class SalePersonTypeGen extends CodeGenerator
{
    ...
    public function generateUpdateCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $personData  ){
            ...
            $code = $code . $this->buildCode('SalePersonTypeIntegrate', 'Update', array(  $updateFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateDeleteCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $personData  ){
            $code = $code . $this->buildCode('SalePersonTypeIntegrate', 'Delete', array( $personData['LID'], $personData['NAME'] ) );
        }
