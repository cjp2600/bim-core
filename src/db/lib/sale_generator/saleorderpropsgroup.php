...
class SaleOrderPropsGroupGen extends CodeGenerator
{
    ...
    public function generateAddCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $groupData  ){
            ...
            $code = $code . $this->buildCode('SaleOrderPropsGroupIntegrate', 'Add', array( $addFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateUpdateCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $groupData  ){
            ...
            $code = $code . $this->buildCode('SaleOrderPropsGroupIntegrate', 'Update', array( $updateFields['NAME'], $updateFields ) ) .PHP_EOL.PHP_EOL;
        }
