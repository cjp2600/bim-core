...
class UserFieldEnumGen extends CodeGenerator
{
    ...
    public function generateAddCode( $params ){
        ...
        foreach( $enumRowList as $enumRow ) {
            ...
            $code = $code . $this->buildCode('UserFieldEnumIntegrate', 'SetEnumValues', array(  $userFieldData['ENTITY_ID'], $userFieldData['FIELD_NAME'], array('n' => $addFields ) ) ) .PHP_EOL.PHP_EOL;
    ...
    public function generateUpdateCode( $params ){
        ...
        foreach( $enumRowList as $enumRow ) {
            ...
            $code = $code . $this->buildCode('UserFieldEnumIntegrate', 'UpdateEnumValues', array(  $userFieldData['ENTITY_ID'], $userFieldData['FIELD_NAME'], $enumRow['XML_ID'], $updateFields ) ) .PHP_EOL.PHP_EOL;
    ...
    public function checkParams( $params ) {
        ...
        foreach( $params['enumRowId'] as $enumRowId ) {
            ...
            $userFieldEnumDbRes = \CUserFieldEnum::GetList( array('SORT' => 'ASC'), array('USER_FIELD_ID' => $params['userFieldId'], 'ID' => $enumRowId ) );
            if ( $userFieldEnumDbRes === false || !$userFieldEnumDbRes->SelectedRowsCount() ) {
