...
class EventMessageGen extends CodeGenerator
{
    ...
    public function generateUpdateCode( $params ){
        ...
        foreach( $ownerItemDbData as $eventMessData ) {
            ...
            $code = $code . $this->buildCode('EventMessageIntegrate', 'Update', array( $updateFields['EVENT_NAME'], $updateFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateDeleteCode( $params ){
        ...
        foreach( $ownerItemDbData as $eventMessData ) {
            unset( $eventMessData['ID'] );
            $code = $code . $this->buildCode('EventMessageIntegrate', 'Delete', array(  $eventMessData['EVENT_NAME'] ) ) .PHP_EOL.PHP_EOL;
        }
