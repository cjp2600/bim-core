...
class CurrencyRatesGen extends CodeGenerator
{
    ...
    public function generateUpdateCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $rateData  ){
            ...
            $code = $code . $this->buildCode('CurrencyRatesIntegrate', 'Update', array( $updateFields['CURRENCY'],  $updateFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateDeleteCode( $params ){
        ...
        foreach( $this->ownerItemDbData as $rateData  ){
            $code = $code . $this->buildCode('CurrencyRatesIntegrate', 'Delete', array( $rateData['CURRENCY'], $rateData['DATE_RATE'] ) );
        }
