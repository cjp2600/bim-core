...
class FormFieldGen extends CodeGenerator
{
    ...
    public function generateAddCode( $params ){
        ...
        foreach( $ownerItemDbData['formFields'] as $formFieldData ) {
            ...
            $code = $code . $this->buildCode('FormFieldIntegrate', 'FormFieldSet', array( $ownerItemDbData['formData']['SID'],  $addFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateUpdateCode( $params ){
        ...
        foreach( $ownerItemDbData['formFields'] as $formFieldData ) {
            ...
            $code = $code . $this->buildCode('FormFieldIntegrate', 'FormFieldSet', array( $ownerItemDbData['formData']['SID'],  $updateFields ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function generateDeleteCode( $params ){
        ...
        foreach( $ownerItemDbData['formFields'] as $formFieldData ) {
            ...
            $code = $code . $this->buildCode('FormFieldIntegrate', 'FormFieldDelete', array(  $formFieldData['SID'] ) ) .PHP_EOL.PHP_EOL;
        }
    ...
    public function checkParams( $params  ) {
        ...
        foreach( $params['formFieldId'] as $formFieldId ) {
            ...
            $answerList = array();
            $formAnswerDbRes =\CFormAnswer::GetList( $formFieldData['ID'], $by="s_id", $order="desc", array(), $filter = false  );
