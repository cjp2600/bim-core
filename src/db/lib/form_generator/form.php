...
class FormGen extends CodeGenerator
{
    ...
    public function generateUpdateCode($params)
    {
        ...
        foreach ($ownerItemDbData as $formData) {
            ...
            $code = $code . $this->buildCode('FormIntegrate', 'FormSet',
                    array($updateFields, $updateFields['SID'])) . PHP_EOL . PHP_EOL;
        }
    ...
    public function generateDeleteCode($params)
    {
        ...
        foreach ($ownerItemDbData as $formData) {
            ...
            $code = $code . $this->buildCode('FormIntegrate', 'FormDelete',
                    array($formData['SID'])) . PHP_EOL . PHP_EOL;
        }
        ...
        foreach ($params['formId'] as $formId) {
            ...
            if (!empty($templateList)) {
                ...
                foreach ($tmpTemplateList as $templateId) {
                    $eventMessageDbRes = \CEventMessage::GetList($by = "id", $order = "desc",
                        array('ID' => $templateId));
