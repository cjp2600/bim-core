...
class FormAnswerGen extends CodeGenerator
{
    ...
    public function generateAddCode($params)
    {
        ...
        foreach ($ownerItemDbData['formAnswers'] as $formAnswerData) {
            ...
            $code = $code . $this->buildCode('FormAnswerIntegrate', 'FormAnswerSet',
                    array($addAnswers, '')) . PHP_EOL . PHP_EOL;
        }
    ...
    public function generateUpdateCode($params)
    {
        ...
        foreach ($ownerItemDbData['formAnswers'] as $formAnswerData) {
            ...
            $code = $code . $this->buildCode('FormAnswerIntegrate', 'FormAnswerSet',
                    array($updateAnswers, $answerFilter)) . PHP_EOL . PHP_EOL;
        }
    ...
    public function generateDeleteCode($params)
    {
        ...
        foreach ($ownerItemDbData['formAnswers'] as $formAnswerData) {
            ...
            $code = $code . $this->buildCode('FormAnswerIntegrate', 'FormAnswerReset',
                    array($questionSID, $answerFilter)) . PHP_EOL . PHP_EOL;
        }
